...
/**
 * TimeScale that maps a time duration onto one hour.
 */
class OneHourTimeScale: CalendarTimeScale() {
    override val type: TimeScaleType = TimeScaleType.ONE_HOUR
    override val nameId: Int = R.string.ts_hour
    override val formatString = "h:mm:ss"
    override val minTime: Calendar =
        GregorianCalendar(2000, Calendar.JANUARY, 1, 11, 0, 0)
    override val maxTime: Calendar =
        GregorianCalendar(2000, Calendar.JANUARY, 1, 12, 0, 0)
}
