 ...
 */
class XUniverseTimeScale : CalendarTimeScale() {
    override val type: TimeScaleType = TimeScaleType.X_UNIVERSE
    override val nameId: Int = R.string.ts_x_universe
    override val formatString = "y G MMMM d\nh:mm:ss a"
    override val minTime: Calendar =
        GregorianCalendar(-4000, Calendar.JANUARY, 1, 0, 0, 0)
